...
The search script lives inside this skill's own directory, not the project directory. Invoke it by the path below from the project root — do not assume a particular working directory:
